    ...
    <div className="mb-1">
      ...
      <div className="section-body">
        <div className="input-control">
          ...
          <i className={`fa fa-wrapper fa-id-card ${props.errors.citizen_id && "text-danger input-error"}`}
             aria-hidden="true" />
        </span>
        </div>
      </div>
...
CitizenID.propTypes = {
  errors: PropTypes.func, useFormRegisterReturn: PropTypes.any, onKeyUp: PropTypes.func
};